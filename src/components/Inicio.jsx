...
import { useCarrito } from '../context/CarritoContext'; // 1. IMPORTAR EL HOOK

function Inicio() {
  const [destacados, setDestacados] = useState([]);
  const { agregarAlCarrito } = useCarrito(); // 2. USAR LA FUNCIÓN DE AGREGAR
  ...
  useEffect(() => {
    fetch('http://localhost:8080/api/productos')
      ...
      .then(data => {
        // Barajamos y tomamos 6 para la portada
                ...
                <Modal.Body>
                    <Row>
                        ...
                        <Col md={6} className="d-flex flex-column justify-content-center mt-3 mt-md-0">
                            ...
                            {/* 4. BOTÓN AÑADIR DEL MODAL CONECTADO */}
